            ...
            <div className={styles.container__product__product}>
              ...
              <div className={styles.container__product__product__info}>
                ...
                <div className={styles.container__product__product__info__button}>
                  <div onClick={addToBasketHandler} className={styles.container__product__product__info__button__add + ' ' + (isBasket ? styles.container__product__product__info__button__add__active : '')}>Добавить в корзину</div>
