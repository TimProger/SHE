            ...
            <div className={s.documents__wrapper}>
              ...
              <div className={s.documents__certificates}>
                ...
                <div className={s.documents__certificates__pdf}>
                  ...
                  <Link href={`${API_BASE_URL}/staticfiles/docx/Протокол Испытаний 42.22.08845.pdf`}>{documents.title5}</Link>
                </div>
                <div className={s.documents__certificates__doc}>
                  ...
                  <Link href={`${API_BASE_URL}/staticfiles/docx/Декларация_о_соответствии_зарег_16999058_от_08_09_2022.docx`}>{documents.title6}</Link>
                </div>
              </div>
              <div className={s.documents__cataloge}>
                ...
                <div className={s.documents__cataloge__exel}>
                  ...
                  <Link href={'https://docs.google.com/spreadsheets/d/1N36PsiRX6w9lfBdollKrGf1HXDeQ3D6u/edit#gid=1385872957'}>{documents.title4}</Link>
                </div>
              </div>
