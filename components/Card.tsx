...
const Card: React.FC<ICardProps> = ({product}) => {
  ...
  return (
    <div className={styles.card + ` ${is_new && styles.card__new} ${is_hit && styles.card__hit}`}>
      ...
      <div className={styles.card__content}>
        ...
        <div className={styles.card__content__footer}>
          <div className={styles.card__content__footer__info}>
            <p>{product.product_more.map(el=>el.ml).join('/')} ml</p>
            <span style={{background: product.color}} className={styles.card__content__footer__color} />
          </div>
